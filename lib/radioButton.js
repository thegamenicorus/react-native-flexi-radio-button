...
export default class RadioButton extends Component{
    ...
    getRadioDotStyle(){
        return {
            height: this.props.dotSize ? this.context.size / this.props.dotSize : this.context.size / 2,
			width: this.props.dotSize ? this.context.size / this.props.dotSize : this.context.size / 2,
			borderRadius: this.props.dotBorderSize ? this.context.size / this.props.dotBorderSize : this.context.size / 4,
